...
\begin{itemize}
	...
	\item The lower bound on the complexity of the function approximation problem in Theorem \ref{thm:A_cost}  demonstrates that Algorithm $A$ is asymptotically optimal.
\end{itemize}
