...
polynomial basis for approximating functions to the level of machine
precision ($\approx 10^{-15}$) by default. In this example, we show that it is challenged
by~$f_3$ defined in Section~\ref{sec:cone}. Near $x=0$ and $x=0.2$, some
pointwise errors of the piecewise Chebyshev interpolant spiked above
