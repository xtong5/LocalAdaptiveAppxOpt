...
$[a,b]=[a,c+1]$ for $g_3$, $g_4$, and $g_5$. The approximation results are
...
\includegraphics[width=70mm]{figure/traub_funappxNoPenalty_g_test.eps}
  \\ a)  & b)
  \end{tabular}
...
theoretical frameworks for error estimation to understandable challenges in
