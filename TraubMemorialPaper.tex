...
by functions. Moreover, interpolation at low to medium accuracy is usually
sufficient to project satisfactory visual perceptions on devices that have
relatively limited memory and low-resolution display, for example, cellphones
and wearables. In the following example, we use \funappxg{} to interpolate the
surface of a seashell, resulting in a sufficiently accurate~3D reconstruction.
