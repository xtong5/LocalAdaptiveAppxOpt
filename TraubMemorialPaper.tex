...
The goal is to solve univariate function approximation and minimization problems by locally adaptive algorithms. For some suitable set, $\cc$, of continuous,
...
\item Our new Algorithms $A$ and $M$ are implemented in our MATLAB Guaranteed Automatic Integration Library (GAIL)  as \funappxg and \funming, respectively.   Section \frednote{Add}
