...
\subsection{The Cone}
The choice of $\cc$ is different than that chosen by \cite{Din15a} and \cite{Ton14a} and is similar to that in \cite{HicRazYun15a}. We will employ linear splines to build our algorithms, and so we will consider functions in the Soboloev space
\[
