...
\newcommand{\frednote}[1]{  {\textcolor{red}  {**Fred: #1 }}}
\newcommand{\yuhannote}[1]{  {\textcolor{darkgreen}  {**Yuhan: #1 }}}
\newcommand{\xinnote}[1]{ {\textcolor{violet}  {**Xin: #1 }}}
...
For any $\{x_1, x_2, x_3\}$ satisfying $a \le x_1 < x_2 < x_3 \le b$ define a
...
that for any intervals $I , J \subseteq [a,b]$ it follows from the definition
that
...
specified interval via Newton divided differences.
...
\end{equation*}
where the $f[\cdots]$ are the Newton divided differences \cite{}. For any $f \in
...
i.e., there exist $\xi_\pm$ with $x_1 < \xi_- < x_2 < x_+ < x_3$ with
...
\end{multline*}
So, the the data-based second order divided difference tells provides an upper
