...
& \le \sup_{a \le x \le b} \min\bigl\{\tB(f,x,h,h) : \max(h_\pm) \in [0,\fh] \bigr \} \qquad \text{by } \eqref{conedef} \\
& \le \sup_{a \le x \le b} \min\bigl\{\tB(f,x,h_,h_+) : \max(h_\pm) \in [0,\fh] \bigr \} \qquad \text{by } \eqref{conedef} \\
\end{align*}
