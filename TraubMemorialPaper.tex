...
\subsection{The Cone Definition}
...
To better understand $\cc$, let's explore what functions $\cc$ includes an what functions $\cc$ excludes.  Consider the two functions defined on $[-1,1]$ whose second derivatives oscillate heavily near $0$: 
\begin{gather*}
...
\section{The Function Approximation Algorithm, $A$}
\begin{algo}
